...
INCLUDES     =   -I include -I gpio/Inc -I sd-spi/Inc -I fat32/Inc -I stm32lib -I shell/Inc -I usb/Inc -I usb/class -I kernel/Inc -I spi/Inc -I w25q/Inc
...
SRCPATH      = $(sort $(dir $(SOURCES) $(SRCLIB) $(SRCGPIO) $(SRCUSB) $(SRCKERNEL) $(SRCSPI) $(SRCSHELL) $(SRCFAT32) $(SRCSDSPI) $(SRCW25Q) ))
vpath %.c $(SRCPATH)
vpath %.S $(SRCPATH)
...
$(DOUT).elf : $(OBJDIR) $(LIBOBJ) $(SHELLOBJ) $(GPIOOBJ) $(USBOBJ) $(kERNELOBJ) $(SPIOBJ) $(SDSPIOBJ) $(FAT32OBJ) $(W25QOBJ) $(OBJECTS) 
	@echo building $@
	@$(LD) $(CFLAGS2) $(LDFLAGS) -Wl,--script='$(LDSCRIPT)' $(LIBOBJ) $(GPIOOBJ) $(SHELLOBJ) $(USBOBJ) $(FAT32OBJ) $(SDSPIOBJ) $(W25QOBJ) $(SPIOBJ) $(kERNELOBJ) $(OBJECTS) -o $@
